...
public: // methods
	...
	Node *GetOpenListStartN()
	{
		float f,g,h;
		return GetOpenListStartN( f,g,h );
	}

	Node *GetOpenListStartN( float &f, float &g, float &h )
	{
		iterDbgOpen = m_OpenList.begin();
		if( iterDbgOpen != m_OpenList.end() )
		{
	...
	Node *GetOpenListNextN()
	{
		float f,g,h;
		return GetOpenListNextN( f,g,h );
	}

	Node *GetOpenListNextN( float &f, float &g, float &h )
	{
		iterDbgOpen++;
		if( iterDbgOpen != m_OpenList.end() )
		{
